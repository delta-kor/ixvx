...
export default function SessionInfo({ music: { title, group, album } }: Props) {
  return (
    <div className="flex px-xl py-md items-center gap-md lg:px-lg lg:py-lg cursor-pointer select-none">
      <Image src={album} alt={title} className="w-[54px] h-[54px] flex-shrink-0 rounded-sm" />
